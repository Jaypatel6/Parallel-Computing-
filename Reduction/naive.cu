...
main(int argc, char** argv)
{
  ...
  fprintf (stdout, "Time to execute naive GPU reduction kernel_Part_0: %Lg secs\n",
	   t_kernel_0);
  double bw = (N * sizeof(dtype)) / (t_kernel_0 * 1e9);		// calculate bandwidth
